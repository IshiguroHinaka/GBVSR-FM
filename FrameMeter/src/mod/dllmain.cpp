...
static const wchar_t supported_version[] = STR("Version:2026/01/28 Revision:72461");
...
bool check_game_version()
{
	...
	wcscpy_s(game_version, sizeof(game_version), (wchar_t *)((char *)module_info.lpBaseOfDll + 0x0474B120));
